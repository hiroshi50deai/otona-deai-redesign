  ...
  if (section && !section.querySelector('.line-editing-priority')) {
    ...
    priority.innerHTML = `
      <div class="line-editing-priority__head">
        <p class="eyebrow">Priority</p><h3>優先して直すポイント</h3>
...
function addSampleReportStyles() {
  if (!location.pathname.endsWith('sample-report.html') || document.querySelector('#sample-report-dynamic-styles')) return;
  const style = document.createElement('style');
  style.id = 'sample-report-dynamic-styles';
  style.textContent = `
